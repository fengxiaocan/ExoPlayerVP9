 ...
 *   <li>Only functionality that is declared as {@linkplain Command available} needs to be
...
public abstract class SimpleBasePlayer extends BasePlayer {
  ...
  protected static final class State {
    ...
    public static final class Builder {
      ...
      private @DiscontinuityReason int positionDiscontinuityReason;
       ...
       *
       * @param playbackSuppressionReason The {@link PlaybackSuppressionReason} why playback
       ...
       * reason for it.
       *
       * @param positionDiscontinuityReason The {@linkplain DiscontinuityReason reason} for
       *     the discontinuity.
    ...
    /**
     * The {@linkplain DiscontinuityReason reason} for the last position discontinuity. The
     * value is unused if {@link #hasPositionDiscontinuity} is {@code false}.
     */
    public final @DiscontinuityReason int positionDiscontinuityReason;
    /**
  ...
  protected SimpleBasePlayer(Looper applicationLooper, Clock clock) {
    ...
    ListenerSet<Listener> listenerSet =
        new ListenerSet<>(
            applicationLooper,
            clock,
   ...
   * Player#seekToNext}).
   *
   * <p>Will only be called if the appropriate {@link Command}, for example {@link
   ...
   * @param seekCommand The {@link Command} used to trigger the seek.
   * @return A {@link ListenableFuture} indicating the completion of all immediate {@link State}
   *     changes caused by this call.
   */
  @ForOverride
  ...
  @RequiresNonNull("state")
  private boolean shouldHandleCommand(@Command int commandCode) {
  ...
  private static @TimelineChangeReason int getTimelineChangeReason(
