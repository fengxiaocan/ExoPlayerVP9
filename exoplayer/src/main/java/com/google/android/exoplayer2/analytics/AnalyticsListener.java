...
public interface AnalyticsListener {
  ...
  /**
   *  Use {@link #onIsLoadingChanged(EventTime, boolean)} instead.
   */
   ...
   *  Use {@link #onCues(EventTime, CueGroup)} instead.
   */
  ...
  /**
   *  Use {@link #onAudioDecoderInitialized(EventTime, String, long, long)}.
   */
  ...
  /**
   *  Use {@link #onVideoDecoderInitialized(EventTime, String, long, long)}.
   */
  ...
  /**
   *  Use {@link #onVideoInputFormatChanged(EventTime, Format, DecoderReuseEvaluation)}.
   */
  ...
  /**
   *  Implement {@link #onVideoSizeChanged(EventTime eventTime, VideoSize)} instead.
   */
  ...
  /**
   *  Implement {@link #onDrmSessionAcquired(EventTime, int)} instead.
   */
