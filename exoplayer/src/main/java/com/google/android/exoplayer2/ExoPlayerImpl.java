...
/* package */ final class ExoPlayerImpl extends BasePlayer
  ...
  public void seekTo(
    ...
    if (isPlayingAd()) {
      ...
      ExoLog.w(TAG, "seekTo ignored because an ad is playing");
  ...
  public void setVideoTextureView(@Nullable TextureView textureView) {
    ...
    if (textureView == null) {
      ...
      if (textureView.getSurfaceTextureListener() != null) {
        ExoLog.w(TAG, "Replacing existing SurfaceTextureListener.");
      }
  ...
  private void removeSurfaceCallbacks() {
    ...
    if (textureView != null) {
      if (textureView.getSurfaceTextureListener() != componentListener) {
        ExoLog.w(TAG, "SurfaceTextureListener already unset or replaced.");
      } else {
  ...
  private void verifyApplicationThread() {
    ...
    if (Thread.currentThread() != getApplicationLooper().getThread()) {
      ...
      ExoLog.w(TAG, message, hasNotifiedFullWrongThreadWarning ? null : new IllegalStateException());
  ...
  private static final class Api31 {
    ...
    public static PlayerId registerMediaMetricsListener(
      ...
      if (listener == null) {
        ExoLog.w(TAG, "MediaMetricsService unavailable.");
