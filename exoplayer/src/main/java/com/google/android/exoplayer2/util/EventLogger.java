...
/**
 * Logs events from {@link Player} and other core components using {@link ExoLog}.
 *
...
public class EventLogger implements AnalyticsListener {
  ...
  private String getEventString(
    ...
    @Nullable String throwableString = ExoLog.getThrowableString(throwable);
