...
public abstract class BasePlayer implements Player {
  ...
  private void seekToCurrentItem(long positionMs, @Command int seekCommand) {
    seekTo(
        getCurrentMediaItemIndex(), positionMs, seekCommand, /* isRepeatingCurrentItem= */ false);
  }

  private void seekToOffset(long offsetMs, @Command int seekCommand) {
  ...
  private void seekToDefaultPositionInternal(int mediaItemIndex, @Command int seekCommand) {
    seekTo(
        mediaItemIndex,
  ...
  private void seekToNextMediaItemInternal(@Command int seekCommand) {
  ...
  private void seekToPreviousMediaItemInternal(@Command int seekCommand) {
  ...
  private void repeatCurrentMediaItem(@Command int seekCommand) {
    seekTo(
