...
public interface Player {
  ...
  final class PositionInfo implements Bundleable {
    ...
    /**
     *  Use {@link #mediaItemIndex} instead.
     */
  ...
  interface Listener {
    ...
    /**
     *  Use {@link #onIsLoadingChanged(boolean)} instead.
     */
    ...
    /**
     *  Use {@link #onPlaybackStateChanged(int)} and {@link
     ...
     * other events that happen in the same {@link Looper} message queue iteration.
     *
     *  Use {@link #onCues(CueGroup)} instead.
     */
  ...
  /**
   *  Use {@link #COMMAND_SEEK_IN_CURRENT_MEDIA_ITEM} instead.
   */
  ...
  /**
   *  Use {@link #COMMAND_SEEK_TO_PREVIOUS_MEDIA_ITEM} instead.
   */
  ...
  /**
   *  Use {@link #COMMAND_SEEK_TO_NEXT_MEDIA_ITEM} instead.
   */
  ...
  /**
   *  Use {@link #COMMAND_SEEK_TO_MEDIA_ITEM} instead.
   */
  ...
  /**
   *  Use {@link #COMMAND_GET_METADATA} instead.
   */
  ...
  /**
   *  Use {@link #COMMAND_SET_PLAYLIST_METADATA} instead.
   */
  ...
  /**
   *  Use {@link #COMMAND_SET_DEVICE_VOLUME_WITH_FLAGS} instead.
   */
  ...
  /**
   *  Use {@link #COMMAND_ADJUST_DEVICE_VOLUME_WITH_FLAGS} instead.
   */
  ...
  /**
   *  Use {@link #hasPreviousMediaItem()} instead.
   */
  ...
  /**
   *  Use {@link #seekToPreviousMediaItem()} instead.
   */
  ...
  /**
   *  Use {@link #hasNextMediaItem()} instead.
   */
  ...
  /**
   *  Use {@link #seekToNextMediaItem()} instead.
   */
  ...
  /**
   *  Use {@link #getCurrentMediaItemIndex()} instead.
   */
  ...
  /**
   *  Use {@link #getNextMediaItemIndex()} instead.
   */
  ...
  /**
   *  Use {@link #getPreviousMediaItemIndex()} instead.
   */
  ...
  /**
   *  Use {@link #isCurrentMediaItemDynamic()} instead.
   */
  ...
  /**
   *  Use {@link #isCurrentMediaItemLive()} instead.
   */
  ...
  /**
   *  Use {@link #isCurrentMediaItemSeekable()} instead.
   */
