...
public final class ConcatenatingMediaSource2 extends CompositeMediaSource<Integer> {
  ...
  public static final class Builder {
    ...
    @Nullable private Factory mediaSourceFactory;
    ...
    /**
     * Sets a {@link Factory} that is used to convert {@link MediaItem MediaItems} to
     * {@link MediaSource MediaSources} for all future calls to {@link #add(MediaItem)} or {@link
     * #add(MediaItem, long)}.
     *
     * @param mediaSourceFactory A {@link Factory}.
     * @return This builder.
     */
    @CanIgnoreReturnValue
    public Builder setMediaSourceFactory(Factory mediaSourceFactory) {
     ...
     * #setMediaSourceFactory(Factory)} must be called before this method.
     *
