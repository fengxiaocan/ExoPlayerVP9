...
public interface RendererCapabilities {
  ...
  /**
   *  Use {@link C.FormatSupport} instead.
   */
  ...
  /**
   *  Use {@link C#FORMAT_HANDLED} instead.
   */
   int FORMAT_HANDLED = C.FORMAT_HANDLED;
  /**
   *  Use {@link C#FORMAT_EXCEEDS_CAPABILITIES} instead.
   */
   int FORMAT_EXCEEDS_CAPABILITIES = C.FORMAT_EXCEEDS_CAPABILITIES;
  /**
   *  Use {@link C#FORMAT_UNSUPPORTED_DRM} instead.
   */
   int FORMAT_UNSUPPORTED_DRM = C.FORMAT_UNSUPPORTED_DRM;
  /**
   *  Use {@link C#FORMAT_UNSUPPORTED_SUBTYPE} instead.
   */
   int FORMAT_UNSUPPORTED_SUBTYPE = C.FORMAT_UNSUPPORTED_SUBTYPE;
  /**
   *  Use {@link C#FORMAT_UNSUPPORTED_TYPE} instead.
   */
   int FORMAT_UNSUPPORTED_TYPE = C.FORMAT_UNSUPPORTED_TYPE;
