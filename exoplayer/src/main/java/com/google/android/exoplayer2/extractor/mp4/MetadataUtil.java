...
/* package */ final class MetadataUtil {
  ...
  public static Metadata.Entry parseIlstElement(ParsableByteArray ilst) {
    ...
    try {
      ...
      ExoLog.d(TAG, "Skipped unknown metadata entry: " + Atom.getAtomTypeString(type));
      return null;
    } finally {
  ...
  private static TextInformationFrame parseTextAttribute(
    ...
    ExoLog.w(TAG, "Failed to parse text attribute: " + Atom.getAtomTypeString(type));
    return null;
  }
  ...
  private static CommentFrame parseCommentAttribute(int type, ParsableByteArray data) {
    ...
    ExoLog.w(TAG, "Failed to parse comment attribute: " + Atom.getAtomTypeString(type));
    return null;
  }
  ...
  private static Id3Frame parseUint8Attribute(
    ...
    ExoLog.w(TAG, "Failed to parse uint8 attribute: " + Atom.getAtomTypeString(type));
    return null;
  }
  ...
  private static TextInformationFrame parseIndexAndCountAttribute(
    ...
    ExoLog.w(TAG, "Failed to parse index/count attribute: " + Atom.getAtomTypeString(type));
    return null;
  }
  ...
  private static TextInformationFrame parseStandardGenreAttribute(ParsableByteArray data) {
    ...
    ExoLog.w(TAG, "Failed to parse standard genre code");
    return null;
  }
  ...
  private static ApicFrame parseCoverArt(ParsableByteArray data) {
    ...
    if (atomType == Atom.TYPE_data) {
      ...
      if (mimeType == null) {
        ExoLog.w(TAG, "Unrecognized cover art flags: " + flags);
        return null;
      }
    ...
    ExoLog.w(TAG, "Failed to parse cover art attribute");
    return null;
  }
  ...
  private static int parseUint8AttributeValue(ParsableByteArray data) {
    ...
    ExoLog.w(TAG, "Failed to parse uint8 attribute value");
    return -1;
  }
}
