...
public class StyledPlayerView extends FrameLayout implements AdViewProvider {
  ...
  /**
   *  Use {@link #getArtworkDisplayMode()} instead.
   */
  ...
  /**
   *  Use {@link #setArtworkDisplayMode(int)} instead.
   */
   ...
   *
   *  Use {@link #setControllerVisibilityListener(ControllerVisibilityListener)} instead.
   */
  @SuppressWarnings("deprecation")
   ...
   * @param listener The listener to be notified when the fullscreen button is clicked, or null to
   *     remove the current listener and hide the fullscreen button.
   *  Use {@link #setFullscreenButtonClickListener(FullscreenButtonClickListener)}
   *     instead.
   */
