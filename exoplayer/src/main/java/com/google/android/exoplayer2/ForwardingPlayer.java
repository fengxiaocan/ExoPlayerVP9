...
public class ForwardingPlayer implements Player {
   ...
   * delegate.addListener}. If the override wants to pass the {@link Listener} instance to
   ...
   * Listener#onEvents(Player, Events)} (i.e. this forwarding instance, and not the
   ...
   *
   * <p>Overrides of this method must <strong>not</strong> directly call {@code
   * delegate.removeListener}. If the override wants to pass the {@link Listener} instance to
