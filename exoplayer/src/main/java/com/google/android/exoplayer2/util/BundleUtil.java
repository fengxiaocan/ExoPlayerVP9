  ...
  private static IBinder getBinderByReflection(Bundle bundle, @Nullable String key) {
    ...
    if (getIBinder == null) {
      try {
        ...
        ExoLog.i(TAG, "Failed to retrieve getIBinder method", e);
        return null;
      }
    ...
    try {
      ...
      ExoLog.i(TAG, "Failed to invoke getIBinder via reflection", e);
      return null;
    }
  }
  ...
  private static void putBinderByReflection(
    ...
    if (putIBinder == null) {
      try {
        ...
        ExoLog.i(TAG, "Failed to retrieve putIBinder method", e);
        return;
      }
    ...
    try {
      ...
      ExoLog.i(TAG, "Failed to invoke putIBinder via reflection", e);
    }
  }
