...
public interface LoadControl {
  ...
  /**
   *  Used as a placeholder when MediaPeriodId is unknown. Only used when the deprecated
  ...
  /**
   *  Implement {@link #onTracksSelected(Timeline, MediaPeriodId, Renderer[],
  ...
  /**
   *  Implement {@link #shouldStartPlayback(Timeline, MediaPeriodId, long, float,
