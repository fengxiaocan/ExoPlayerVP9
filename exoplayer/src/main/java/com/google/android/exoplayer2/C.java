...
public final class C {
  ...
  /**
   *  Use {@link #AUDIO_CONTENT_TYPE_MOVIE} instead.
   */
   public static final int CONTENT_TYPE_MOVIE = AUDIO_CONTENT_TYPE_MOVIE;
  ...
  /**
   *  Use {@link #AUDIO_CONTENT_TYPE_MUSIC} instead.
   */
   public static final int CONTENT_TYPE_MUSIC = AUDIO_CONTENT_TYPE_MUSIC;
  /** See {@link AudioAttributes#CONTENT_TYPE_SONIFICATION}. */
  public static final int AUDIO_CONTENT_TYPE_SONIFICATION =
      AudioAttributes.CONTENT_TYPE_SONIFICATION;
  /**
   *  Use {@link #AUDIO_CONTENT_TYPE_SONIFICATION} instead.
   */
  ...
  /**
   *  Use {@link #AUDIO_CONTENT_TYPE_SPEECH} instead.
   */
   public static final int CONTENT_TYPE_SPEECH = AUDIO_CONTENT_TYPE_SPEECH;
  ...
  /**
   *  Use {@link #AUDIO_CONTENT_TYPE_UNKNOWN} instead.
   */
  ...
  /**
   *  Use {@link #CONTENT_TYPE_DASH} instead.
   */
  ...
  /**
   *  Use {@link #CONTENT_TYPE_SS} instead.
   */
   public static final int TYPE_SS = CONTENT_TYPE_SS;
  /** Value representing an HLS manifest. */
  public static final int CONTENT_TYPE_HLS = 2;
  /**
   *  Use {@link #CONTENT_TYPE_HLS} instead.
   */
   public static final int TYPE_HLS = CONTENT_TYPE_HLS;
  /** Value representing an RTSP stream. */
  public static final int CONTENT_TYPE_RTSP = 3;
  /**
   *  Use {@link #CONTENT_TYPE_RTSP} instead.
   */
   public static final int TYPE_RTSP = CONTENT_TYPE_RTSP;
  ...
  /**
   *  Use {@link #CONTENT_TYPE_OTHER} instead.
   */
   public static final int TYPE_OTHER = CONTENT_TYPE_OTHER;
  ...
  /**
   *  Use {@link Util#generateAudioSessionIdV21(Context)}.
   */
  @InlineMe(
  ...
  /**
   *  Use {@link Util#getFormatSupportString(int)}.
   */
  @InlineMe(
  ...
  /**
   *  Use {@link Util#getErrorCodeForMediaDrmErrorCode(int)}.
   */
  @InlineMe(
