...
public final class MediaMetadata implements Bundleable {
  ...
  public static final class Builder {
    ...
    /**
     *  Use {@link #setArtworkData(byte[] data, Integer pictureType)} or {@link
     ...
     *
     *  Use {@link #setIsBrowsable} to indicate if an item is a browsable folder and use
    ...
    /**
     *  Use {@link #setRecordingYear(Integer)} instead.
     */
    @CanIgnoreReturnValue
   ...
   *
   *  Use {@link #isBrowsable} to indicate if an item is a browsable folder and use
   ...
   *
   *  Use {@link #isBrowsable} set to false instead.
   */
   public static final int FOLDER_TYPE_NONE = -1;
  /**
   * Type for a folder containing media of mixed types.
   *
   *  Use {@link #isBrowsable} set to true and {@link #mediaType} set to {@link
   ...
   *
   *  Use {@link #isBrowsable} set to true instead.
   */
  ...
  /**
   *  Use {@link #recordingYear} instead.
   */
