...
public abstract class Timeline implements Bundleable {
  ...
  /**
   *  Use {@link #getPeriodPositionUs(Window, Period, int, long)} instead.
   */
  ...
  /**
   *  Use {@link #getPeriodPositionUs(Window, Period, int, long, long)} instead.
   */
